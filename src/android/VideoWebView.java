...
/**
 * This class serves as a WebView to be used in conjunction with a VideoWebChromeClient.
 * It makes possible:
 * - To detect the HTML5 video ended event so that the VideoWebChromeClient can exit full-screen.
 * <p>
 * Important notes:
...
public class VideoWebView extends WebView {
    public class JavascriptInterface {
        ...
        public void notifyVideoEnd() // Must match Javascript interface method of VideoWebChromeClient
        {
            Log.d("___", "GOT IT");
    ...
    private void addJavascriptInterface() {
        if (!addedJavascriptInterface) {
            ...
            //noinspection all
            addJavascriptInterface(new JavascriptInterface(), "_VideoWebView"); // Must match Javascript interface name of VideoWebChromeClient
