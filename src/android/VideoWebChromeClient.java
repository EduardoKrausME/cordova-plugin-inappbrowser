...
public class VideoWebChromeClient extends WebChromeClient
     ...
     * @param activityVideoView    A ViewGroup in the activity's layout that will display the video. Typically you would like this to fill the whole layout.
     * @param loadingView          A View to be shown while the video is loading (typically only used in API level <11). Must be already inflated and not attached to a parent view.
     * @param webView              The owner VideoWebView. Passing it will enable the VideoWebChromeClient to detect the HTML5 video ended event and exit full-screen.
            ...
            if (focusedChild instanceof android.widget.VideoView) {
                ...
                if (webView != null && webView.getSettings().getJavaScriptEnabled() && focusedChild instanceof SurfaceView) {
                    ...
                    js += "if (_ytrp_html5_video != undefined && _ytrp_html5_video != _ytrp_html5_video_last) {";
                    {
                        ...
                        {
                            js += "_VideoWebView.notifyVideoEnd();"; // Must match Javascript interface name and method of VideoEnableWebView
                        }
                        js += "}";
